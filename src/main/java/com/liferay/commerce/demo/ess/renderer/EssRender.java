package com.liferay.commerce.demo.ess.renderer;

import com.liferay.asset.kernel.service.AssetEntryLocalService;
import com.liferay.asset.kernel.service.AssetVocabularyLocalService;
import com.liferay.commerce.demo.ess.renderer.display.context.RendererDisplayContext;
...
public class EssRender implements CPContentListRenderer {

        public static final String KEY = "ess-list";
        ...
        public String getLabel(Locale locale) {
                ...
                return LanguageUtil.get(resourceBundle, "ess-list");
        }
        ...
        @Reference(
                target = "(osgi.web.symbolicname=com.liferay.commerce.demo.ess.renderer)"
        )
